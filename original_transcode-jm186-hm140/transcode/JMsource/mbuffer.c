...
//=============================================================================================================
int get_one_frame_from_dpb(DecodedPictureBuffer *p_Dpb,unsigned char *tempY,unsigned char *tempU,unsigned char *tempV)
{
	VideoParameters *p_Vid = p_Dpb->p_Vid;
	int poc, pos;
	//diagnostics
...
#if (MVC_EXTENSION_ENABLE)
	get_stored_frame(p_Vid, p_Dpb->fs[pos], p_Vid->p_out_mvc[p_Dpb->layer_id],tempY,tempU,tempV);
#else
	get_stored_frame(p_Vid, p_Dpb->fs[pos], p_Vid->p_out,tempY,tempU,tempV);
#endif
