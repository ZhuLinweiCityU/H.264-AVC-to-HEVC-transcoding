...
extern void decode_one_slice  (Slice *currSlice,CvMat *Feature0,CvMat *Feature1,CvMat *Feature2,int indexframe);
extern int  read_new_slice    (Slice *currSlice);
extern void exit_picture      (VideoParameters *p_Vid, StorablePicture **dec_picture);
extern int  decode_one_frame  (DecoderParams *pDecoder,CvMat *Feature0,CvMat *Feature1,CvMat *Feature2,int indexframe);//zhulinwei
...
extern void decode_slice(Slice *currSlice, int current_header,CvMat *Feature0,CvMat *Feature1,CvMat *Feature2,int indexframe);
