...
Return: 
       ...
       others: Error Code;
************************************/
int DecodeOneFrame(DecodedPicList **ppDecPicList,CvMat *Feature0,CvMat *Feature1,CvMat *Feature2,int indexframe)
{
  int iRet;
  DecoderParams *pDecoder = p_Dec;
  ClearDecPicList(pDecoder->p_Vid);
  iRet = decode_one_frame(pDecoder,Feature0,Feature1,Feature2,indexframe);
  if(iRet == SOP)
  {
    iRet = DEC_SUCCEED;
  }
